...
{ name: 'MICHAEL DATHAN', locationId: 'lmdh', commentId: 'cmdh', workshop: 'JHH' }, { name: 'MITCHELL PACEY', locationId: 'lmjp', commentId: 'cmjp', workshop: 'JHH' }, { name: 'STEVEN BRADBURY', locationId: 'lsb', commentId: 'csb', workshop: 'JHH' },
...
"WEEWAA", "BINGARA", "BUNDARRA", "GLEN_INNES", "EMMAVILLE", "MOREE", "WARIALDA", "INVERELL", "TENTERFIELD", "CARDIOVASCULAR", "RESPIRATORY"];
...
const locationOptions = {
    level3: ['ICU', 'JHH OPERATING THEATRE', 'JHH RECOVERY', 'DELIVERY SUITE', 'NICU', 'HAPS LVL 3', 'RNC OPERATING THEATRE', 'RNC RECOVERY',
        'CATHLAB', 'ENDOSCOPY', 'LAB 5', 'WARD E3', 'WARD F3', 'WARD G3', 'WARD H3', 'WARD J3', 'WARD K3', 'CCU', 'CARDIOVASCULAR'],
    level2: ['SOUTH BLOCK', 'NORTH BLOCK', 'DIAGNOSTIC CENTRE', 'IMAGING', 'EMERGENCY', 'PATHOLOGY', 'GP ACCESS', 'SLEEP LAB', 'ALLIED HEALTH',
        ...
        'WARD J2', 'WARD K2', 'NEXUS', 'NUCLEAR MEDICINE', 'NEUROLOGY', 'GASTROENTEROLOGY', 'AUDIOLOGY', 'INNOVATIONS LAB', 'RESPIRATORY'],
